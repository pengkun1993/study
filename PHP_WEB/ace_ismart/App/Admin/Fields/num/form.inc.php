...
if($G_from_type=='add'){
	$from_return='<input name="'.$field_one['name'].'" value="'.$field_one['value'].'" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3">';
}elseif($G_from_type=='edit'){
	$from_return='<input name="'.$field_one['name'].'" value="{$_info["'.$field_one['name'].'"]}" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3">';
}else{
	$from_return='<input name="s_'.$field_one['name'].'" type="text" class="easyui-numberbox" class="col-xs-10">';
}
return $from_return;