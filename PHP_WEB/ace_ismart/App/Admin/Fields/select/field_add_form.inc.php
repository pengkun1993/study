<table width="100%">
  <tr>
    <th>数据来源:</th>
    <td><select name="extra[type]" class="easyui-combobox" data-options="value:'1',editable:false" style="height:30px">
  ...
  <tr>
    ...
    4> 方法：例(Admin/AuthGroup/get_auth_role|id|text)其中第一个是方法名称，其中第一个是方法名，第二个是选项值，第三个是选项名显
    </td>
  </tr>
  <tr>
    <th>参数:</th>
