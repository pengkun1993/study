...
if($G_from_type=='add'){
	$from_return='<input name="'.$field_one['name'].'" value="'.$field_one['value'].'" type="text" class="'.$class.' col-xs-6 col-sm-3 col-lg-3 col-md-3" style="height:30px;" data-options="'.$extra_show.'">';
}elseif($G_from_type=='edit'){
	$from_return='<input name="'.$field_one['name'].'" value="{$_info["'.$field_one['name'].'"]|date=\''.$date_Ymd.'\',###}" type="text" class="'.$class.' col-xs-6 col-sm-3 col-lg-3 col-md-3"style="height:30px;" data-options="'.$extra_show.'">';
}else{
