	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Lunbo_Form">
			<div class="form-group">
					...
					<div class="col-xs-11">
						<input id="img_picture_box" name="picture" value="<?php echo ($_info["picture"]); ?>" class="easyui-textbox col-xs-6 col-sm-2 col-lg-2 col-md-2" data-options="buttonText:'选择',buttonIcon:'iconfont icon-pic',prompt:'上传图片...',onClickButton:function(){updata_image('img_picture_box')}" style="height:30px;">											</div>
				</div>
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<input name="srot" value="<?php echo ($_info["srot"]); ?>" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3">											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-xs-5 col-sm-1 control-label no-padding-right" for="form-field-1">链接:</label>

					<div class="col-xs-11">
						<input name="url" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3" value="<?php echo ($_info["url"]); ?>" >											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-xs-5 col-sm-1 control-label no-padding-right" for="form-field-1">状态:</label>

					<div class="col-xs-11">
						<select name="state" class="col-xs-7 col-sm-3 col-lg-3 col-md-3" id="s_state"  def-data="<?php echo ($_info['state']); ?>"><option value="1">显示</option><option value="0">不显示</option></select><script type="text/javascript">
