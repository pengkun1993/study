...
<body>
	<div class="fixed-bar" id="pengkun_Bar">
		<div class="item-title">
			<div class="page-header">
				<h1><a href="<?php echo U('Admin/pengkun/index');?>">鹏坤</a>
					<small>
	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="pengkun_Form">
			<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">标题:</label>

					<div class="col-sm-9">
						<input name="title" type="text" class="col-xs-2" value="">											</div>
				</div>
				<div class="space-20"></div><div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1">状态:</label>

					<div class="col-sm-9">
						<select name="state" class="col-xs-2"><option value="0" >隐藏</option><option value="1" selected>显示</option></select>											</div>
				</div>
				<div class="space-20"></div>			<div class="clearfix">
				<div class="col-md-offset-3 col-md-9">
					<button class="btn btn-lg btn-success" type="button" onclick="$('#pengkun_Form').submit();">
