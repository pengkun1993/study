...
<body>
	<div class="fixed-bar" id="Qualification_Bar">
		<div class="item-title">
			<div class="page-header">
				<h1><a href="<?php echo U('Admin/Qualification/index');?>">企业资质</a>
					<small>
	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Qualification_Form">
			<div class="form-group">
				...
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">证书:</label>
		...
		for(var i=0;i<opt.length;i++){
			if(def==opt[i].value){
				...
				<div class="col-md-offset-1 col-md-9">
					<button class="btn btn-lg btn-success" type="button" onclick="$('#Qualification_Form').submit();">
