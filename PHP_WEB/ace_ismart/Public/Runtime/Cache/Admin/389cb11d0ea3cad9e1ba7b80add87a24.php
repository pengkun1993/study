...
<div class="col-xs-12 marg-top">
	<form class="form-horizontal" role="form" method="POST" id="Config_Form">
		<div class="form-group">
			...
			<div class="col-xs-11">
				<input type="text" placeholder="" class="col-xs-9 col-sm-3" name="name" />
			</div>
		</div>
		<hr/>
		<div class="form-group">
			...
			<div class="col-xs-11">
				<select name="type" class="easyui-combobox col-xs-8 col-sm-2" style="height:30px;" data-options="value:'0',url:'<?php echo U("Admin/Function/get_config");?>&cname=CONFIG_TYPE_LIST|type|title&r_type=json',valueField:'type',textField:'title',multiple:false,required:false,editable:false"></select>
			</div>
		</div>
		<hr/>
		<div class="form-group">
			...
			<div class="col-xs-11">
				<input name="title" type="text" class="easyui-textbox col-xs-9 col-sm-3" style="height:30px;">
			</div>
		</div>
		<hr/>
		<div class="form-group">
			...
			<div class="col-xs-11">
				<select name="group" class="easyui-combobox col-xs-8 col-sm-2" style="height:30px;" data-options="value:'1',url:'<?php echo U("Admin/Function/get_config");?>&cname=CONFIG_GROUP_LIST|group|title&r_type=json',valueField:'group',textField:'title',multiple:false,required:false,editable:false"></select>
			</div>
		</div>
		<hr/>
		<div class="form-group">
			...
			<div class="col-xs-11">
				<input name="extra" value="" type="text" class="col-xs-9 col-sm-3">
			</div>
		</div>
		<hr/>
		<div class="form-group">
			<label class="col-sm-1 control-label no-padding-right" for="for_name"> 配置说明: </label>
			<div class="col-xs-11">
				<input name="remark" value="" type="text" class="col-xs-9 col-sm-3" style="height:80px;">
			</div>
		</div>
		<hr/>
		<div class="form-group">
			...
			<div class="col-xs-11">
				<select name="status" class="col-xs-7 col-sm-3" >
		...
		<div class="form-group">
			...
			<div class="col-xs-11">
				<input name="value" value="" type="text" class="col-xs-9 col-sm-3" style="height:100px;">
			</div>
		</div>
		<hr/>
		<div class="form-group">
			...
			<div class="col-xs-11">
				<input name="sort" value="0" type="text" class="col-xs-9 col-sm-3">
			</div>
		</div>
		<hr/>
		<div class="clearfix">
