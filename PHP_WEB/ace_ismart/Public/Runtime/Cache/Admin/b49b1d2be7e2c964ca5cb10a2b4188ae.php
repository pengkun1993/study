		...
		for(var i=0;i<opt.length;i++){
			if(def==opt[i].value){
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<select name="rules[]" class="col-xs-9 col-sm-2  easyui-combotree" data-options="value:'<?php echo ($_info["rules"]); ?>',url:'<?php echo U("Admin/Function/get_auth_rule");?>&r_type=json',valueField:'id',textField:'text',multiple:true,cascadeCheck:false,required:false,editable:false" style="height:30px;"></select>											</div>
				</div>
				<hr/><div class="form-group">
