	...
	<div class="fixed-bar" id="ActionLog_Bar">
		<div class="item-title">
			<div class="page-header">
				<h1>
					<a href="<?php echo U('Admin/ActionLog/index');?>">行为日志</a>
					<small> <i class="icon-double-angle-right"></i>
						<span class="lead">&nbsp;&nbsp;查看详情</span>
					</small>
				</h1>
			</div>
		</div>
	...
	<div class="col-xs-12 marg-top">
		<div class="form-group">
			...
			<span class="remove_bold">
				<?php echo get_action($_info["action_id"],'title');?>[<?php echo ($_info["action_id"]); ?>]
			</span> 
			</p>
		</div>
		<hr/>
		<div class="form-group">
			...
			执行用户:
			<span class="remove_bold">
				<?php echo get_nickname($_info["user_id"]);?>[<?php echo ($_info["user_id"]); ?>]
			</span> 
			</p>
		</div>
		<hr/>
		...
		<div class="clearfix">
			<div class="col-md-offset-1 col-md-9">
				<button class="btn btn-md btn-success" type="button" onclick="history.go(-1)" >
