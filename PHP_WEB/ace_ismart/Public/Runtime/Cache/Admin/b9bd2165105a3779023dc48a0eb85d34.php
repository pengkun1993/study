	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Product_Form">
			<div class="form-group">
					...
					<div class="col-xs-11">
						<select name="pid" class="col-xs-9 col-sm-2  easyui-combobox" data-options="value:'<?php echo ($_info["pid"]); ?>',url:'<?php echo U("Admin/Function/get_types");?>&r_type=json',valueField:'id',textField:'text',multiple:false,required:false,editable:false" style="height:30px;"></select>											</div>
				</div>
		...
		$("#content_editor").blur(function()
		{
			$("#editor_content").html($("#content_editor").html());
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<input name="pubtime" value="<?php echo (date('Y-m-d',$_info["pubtime"])); ?>" type="text" class="easyui-datebox col-xs-6 col-sm-3 col-lg-3 col-md-3"style="height:30px;" data-options="required:false">											</div>
				</div>
				<hr/><div class="form-group">
