	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="AuthRule_Form">
			<div class="form-group">
					...
					<div class="col-xs-11">
						<select name="pid" class="col-xs-9 col-sm-2  easyui-combotree" data-options="value:'0',url:'<?php echo U("Admin/Function/get_auth_rule");?>&r_type=json&pid=-1',multiple:false,required:false,editable:false" style="height:30px;"></select>											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">图表:</label>

					<div class="col-xs-11">
						<select name="icon" class="col-xs-9 col-sm-2   easyui-combobox" data-options="value:'',url:'<?php echo U("Admin/Function/get_icon");?>&r_type=json',valueField:'id',textField:'text',multiple:false,required:false,editable:false,formatter: function(row){
				...
				>节点</option><option value="2"
				>菜单</option><option value="3"
				>外链</option></select><script type="text/javascript">
			...
			for(var i=0;i<opt.length;i++){
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<select name="hide" class="col-xs-7 col-sm-3 col-lg-3 col-md-3" id="s_hide"  def-data="0"><option value="0"
			...
			for(var i=0;i<opt.length;i++){
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<textarea class="col-xs-10 col-sm-3 col-lg-3 col-md-3" name="condition" style=" height:80px;"></textarea>											</div>
				</div>
