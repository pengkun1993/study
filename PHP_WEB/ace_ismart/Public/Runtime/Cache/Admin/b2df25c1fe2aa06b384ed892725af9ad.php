	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Categroy_Form">
			<div class="form-group">
					...
					<div class="col-xs-11">
						<select name="pid" class="col-xs-9 col-sm-2  easyui-combotree" data-options="value:'<?php echo ($_info["pid"]); ?>',url:'<?php echo U("Admin/Function/get_categroy");?>&r_type=json&pid=-1',multiple:false,required:false,editable:false" style="height:30px;"></select>											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-xs-5 col-sm-1 control-label no-padding-right" for="form-field-1">图标:</label>

					<div class="col-xs-11">
						<select name="icon" class="col-xs-9 col-sm-2  easyui-combobox" data-options="value:'<?php echo ($_info["icon"]); ?>',url:'<?php echo U("Admin/Function/get_icon");?>&r_type=json',valueField:'id',textField:'text',multiple:false,required:true,editable:false,formatter: function(row){
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<input name="catname" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3" value="<?php echo ($_info["catname"]); ?>" >											</div>
				</div>
				<hr/><div class="form-group">
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<select name="ismenu" class="col-xs-7 col-sm-3 col-lg-3 col-md-3" id="s_ismenu"  def-data="<?php echo ($_info['ismenu']); ?>"><option value="0">非导航</option><option value="1">是导航</option></select><script type="text/javascript">
		...
		for(var i=0;i<opt.length;i++){
			if(def==opt[i].value){
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<input name="url_name" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3" value="<?php echo ($_info["url_name"]); ?>" >											</div>
				</div>
