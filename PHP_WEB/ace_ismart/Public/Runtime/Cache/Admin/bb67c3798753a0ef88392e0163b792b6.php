...
<body>
	<div class="fixed-bar" id="Position_Bar">
		<div class="item-title">
			<div class="page-header">
				<h1><a href="<?php echo U('Admin/Position/index');?>">招聘职位</a>
					<small>
	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Position_Form">
			<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">职位名称:</label>

					<div class="col-xs-11">
						<input name="name" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3" value="<?php echo ($_info["name"]); ?>" >											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">工作地点:</label>

					<div class="col-xs-11">
						<input name="place" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3" value="<?php echo ($_info["place"]); ?>" >											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">招聘人数:</label>

					<div class="col-xs-11">
						<input name="number" value="<?php echo ($_info["number"]); ?>" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3">											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">薪资待遇:</label>

					<div class="col-xs-11">
						<input name="salary" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3" value="<?php echo ($_info["salary"]); ?>" >											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">发布日期:</label>

					<div class="col-xs-11">
						<input name="publicdate" value="<?php echo (date('Y-m-d H:i:s',$_info["publicdate"])); ?>" type="text" class="easyui-datetimebox col-xs-6 col-sm-3 col-lg-3 col-md-3"style="height:30px;" data-options="required:false">											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">结束日期:</label>

					<div class="col-xs-11">
						<input name="enddate" value="<?php echo (date('Y-m-d',$_info["enddate"])); ?>" type="text" class="easyui-datebox col-xs-6 col-sm-3 col-lg-3 col-md-3"style="height:30px;" data-options="required:false">											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">工作内容:</label>
	...
	<script type="text/javascript">
		$("#content_editor").blur(function()
		{
			$("#editor_content").html($("#content_editor").html());
				...
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">岗位要求:</label>

					<div class="col-xs-11">
						
	<div class="col-xs-12 col-sm-6 col-lg-6 col-md-6">
	<div class="wysiwyg-editor editor" id="request_editor"><?php echo (htmlspecialchars_decode($_info["request"])); ?></div>
	<textarea style="display:none" id="editor_request" name="request"><?php echo (htmlspecialchars_decode($_info["request"])); ?></textarea>
	<script type="text/javascript">
		$("#content_editor").blur(function()
		{
		...
		for(var i=0;i<opt.length;i++){
			if(def==opt[i].value){
				...
				<div class="col-md-offset-1 col-md-9">
					<button class="btn btn-lg btn-success" type="button" onclick="$('#Position_Form').submit();">
