...
<body>
	<div class="fixed-bar" id="Message_Bar">
		<div class="item-title">
			<div class="page-header">
				<h1><a href="<?php echo U('Admin/Message/index');?>">留言</a>
					<small>
	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Message_Form">
			<div class="form-group">
					<label class="col-xs-1 control-label no-padding-right" for="form-field-1">姓名:</label>

					<div class="col-xs-11">
						<input name="username" type="text" class="col-xs-3" value="">											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-xs-1 control-label no-padding-right" for="form-field-1">邮箱:</label>

					<div class="col-xs-11">
						<input name="email" type="text" class="col-xs-3" value="">											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-xs-1 control-label no-padding-right" for="form-field-1">留言:</label>

					<div class="col-xs-11">
						<textarea class="col-xs-3" name="message" style=" height:200px;"></textarea>											</div>
				</div>
				<hr/>			<div class="clearfix">
				<div class="col-md-offset-1 col-md-9">
					<button class="btn btn-lg btn-success" type="button" onclick="$('#Message_Form').submit();">
