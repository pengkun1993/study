	...
	<div class="item-title">
		<div class="page-header">
			<h1>招聘职位				<small>
					...
					<?php if(Is_Auth('Admin/Position/add')): ?><a class="top_a" href="<?php echo U('Admin/Position/add');?>"><span>新增</span></a><?php endif; ?>
				</small>
			</h1>
		</div>
	</div>
...
{field : "name",title : "职位名称",width :100,sortable:true},{field : "place",title : "工作地点",width :100,sortable:true},{field : "number",title : "招聘人数",width :100,sortable:true},{field : "salary",title : "薪资待遇",width :100,sortable:true},{field : "state",title : "状态",width :100,sortable:true,formatter: function (value, row, index) {
			...
			return op_state[value];
				...
				<?php if(Is_Auth('Admin/Position/edit')): ?>operate_menu = operate_menu+"<a href='<?php echo U('edit'); ?>&id="+row.id+"' >编辑</a>";<?php endif; ?>

				<?php if(Is_Auth('Admin/Position/del')): ?>operate_menu = operate_menu+" | <a href='#' onclick=\"Data_Remove('<?php echo U('del'); ?>&id="+row.id+"','Position_Data_List');\">删除</a>";<?php endif; ?>
