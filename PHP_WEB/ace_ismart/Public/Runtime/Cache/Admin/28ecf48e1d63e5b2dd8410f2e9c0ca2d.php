...
<body>
	<div class="fixed-bar" id="Histroy_Bar">
		<div class="item-title">
			<div class="page-header">
				<h1><a href="<?php echo U('Admin/Histroy/index');?>">发展历程</a>
					<small>
	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Histroy_Form">
			<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">年份:</label>

					<div class="col-xs-11">
						<input name="year" value="<?php echo ($_info["year"]); ?>" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3">											</div>
				</div>
		...
		for(var i=0;i<opt.length;i++){
			if(def==opt[i].value){
				...
				<div class="col-md-offset-1 col-md-9">
					<button class="btn btn-lg btn-success" type="button" onclick="$('#Histroy_Form').submit();">
