...
<body>
	<div class="fixed-bar" id="Product_Bar">
		<div class="item-title">
			<div class="page-header">
				<h1><a href="<?php echo U('Admin/Product/index');?>">产品与服务</a>
					<small>
	...
	<div class="col-xs-12 marg-top">
		<form class="form-horizontal" role="form" method="POST" id="Product_Form">
			<div class="form-group">
					<label class="col-xs-5 col-sm-1 control-label no-padding-right" for="form-field-1">所属类别:</label>

					<div class="col-xs-11">
						<select name="pid" class="col-xs-9 col-sm-2   easyui-combobox" data-options="value:'4',url:'<?php echo U("Admin/Function/get_types");?>&r_type=json',valueField:'id',textField:'text',multiple:false,required:false,editable:false" style="height:30px;"></select>											</div>
				</div>
				...
				<hr/><div class="form-group">
					<label class="col-xs-5 col-sm-1 control-label no-padding-right" for="form-field-1">头图:</label>

					<div class="col-xs-11">
						<input id="img_head_pic_box" name="head_pic" value="" class="easyui-textbox col-xs-6 col-sm-2  col-lg-2  col-md-2 " data-options="buttonText:'选择',buttonIcon:'iconfont icon-pic',prompt:'上传图片...',onClickButton:function(){updata_image('img_head_pic_box')}" style="height:30px;" >											</div>
				</div>
				<hr/><div class="form-group">
					<label class="col-xs-5 col-sm-1 control-label no-padding-right" for="form-field-1">内容:</label>
	...
	<script type="text/javascript">
		$("#content_editor").blur(function()
		{
			$("#editor_content").html($("#content_editor").html());
				...
				<hr/><div class="form-group">
					<label class="col-xs-5 col-sm-1 control-label no-padding-right" for="form-field-1">发布时间:</label>

					<div class="col-xs-11">
						<input name="pubtime" value="1" type="text" class="easyui-datebox col-xs-6 col-sm-3 col-lg-3 col-md-3" style="height:30px;" data-options="required:false">											</div>
				</div>
				<hr/><div class="form-group">
			...
			for(var i=0;i<opt.length;i++){
				...
				<div class="col-md-offset-1 col-md-9">
					<button class="btn btn-lg btn-success" type="button" onclick="$('#Product_Form').submit();">
