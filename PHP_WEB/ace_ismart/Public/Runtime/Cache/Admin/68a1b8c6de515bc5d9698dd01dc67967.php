...
class <?php echo ($ModelInfo['name']); ?>Model extends Model{
    ...
    /*模型中定义的表*/
	protected $tableName = '<?php echo ($ModelInfo['table_name']); ?>'; 
...
';}}?> 
    ...
    <?php foreach ($ModelField as $key => $field_one ) { if($field_one['type']=='datetime'){ echo '		array("'.$field_one['name'].'","strtotime",3,"function"),
    '; } if($field_one['auto_rule']!=''){ echo '		'.$field_one['auto_rule'].'
    '; } }?> 
	);
