	...
	<div class="item-title">
		<div class="page-header">
			<h1>产品与服务				<small>
					...
					<?php if(Is_Auth('Admin/Product/add')): ?><a class="top_a" href="<?php echo U('Admin/Product/add');?>"><span>新增</span></a><?php endif; ?>
				</small>
			</h1>
		</div>
	</div>
...
<div style="display: none">
  <form id="Product_Search_From" class="search_from">
    ...
    <div class="form-group">
			...
			<div class="col-xs-10">
				<select name="pid" class="col-xs-9 easyui-combobox" data-options="value:'',url:'<?php echo U("Admin/Function/get_types");?>&r_type=json',valueField:'id',textField:'text',multiple:false,required:false,editable:false" style="height:30px;"></select>			</div>
		</div>
...
{field : "title",title : "标题",width :150,sortable:true},{field : "status",title : "状态",width :100,sortable:true,formatter: function (value, row, index) {
			...
			{field : "search_count",title : "搜索次数",width :100,sortable:true},			{field : "operate",title : "操作",width : 200,formatter: function (value, row, index) {
				...
				<?php if(Is_Auth('Admin/Product/edit')): ?>operate_menu = operate_menu+"<a href='<?php echo U('edit'); ?>&id="+row.id+"' >编辑</a>";<?php endif; ?>

				<?php if(Is_Auth('Admin/Product/del')): ?>operate_menu = operate_menu+" | <a href='#' onclick=\"Data_Remove('<?php echo U('del'); ?>&id="+row.id+"','Product_Data_List');\">删除</a>";<?php endif; ?>
