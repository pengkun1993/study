	...
	<div class="item-title">
		<div class="page-header">
			<h1>轮播图				<small>
					...
					<?php if(Is_Auth('Admin/Lunbo/add')): ?><a class="top_a" href="<?php echo U('Admin/Lunbo/add');?>"><span>新增</span></a><?php endif; ?>
				</small>
			</h1>
		</div>
	</div>
...
{field : "title",title : "标题",width :100,sortable:true},{field : "abstract",title : "摘要",width :100,sortable:true},{field : "srot",title : "显示顺序",width :100,sortable:true},{field : "url",title : "链接",width :100,sortable:true},{field : "state",title : "状态",width :100,sortable:true,formatter: function (value, row, index) {
			...
			return op_state[value];
				...
				<?php if(Is_Auth('Admin/Lunbo/edit')): ?>operate_menu = operate_menu+"<a href='<?php echo U('edit'); ?>&id="+row.id+"' >编辑</a>";<?php endif; ?>

				<?php if(Is_Auth('Admin/Lunbo/del')): ?>operate_menu = operate_menu+" | <a href='#' onclick=\"Data_Remove('<?php echo U('del'); ?>&id="+row.id+"','Lunbo_Data_List');\">删除</a>";<?php endif; ?>
