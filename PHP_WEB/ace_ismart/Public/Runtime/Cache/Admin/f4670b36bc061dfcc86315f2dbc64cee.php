...
<body>
<div class="fixed-bar" id="Qualification_Bar">
	<div class="item-title">
		<h3>企业资质</h3>
		<ul class="tab-base">
			<li><a class="current" href="JavaScript:void(0);" onclick="Data_Reload('Qualification_Data_List');"><span>列表</span></a></li>
			<li><a href="JavaScript:void(0);" onclick="Data_Search('Qualification_Search_From','Qualification_Data_List');"><span>搜索</span></a></li>
			<?php if(Is_Auth('Admin/Qualification/add')): ?><li><a href="<?php echo U('Admin/Qualification/add');?>"><span>新增</span></a></li><?php endif; ?>
		</ul>
	</div>
</div>
<div style="display: none">
  <form id="Qualification_Search_From" class="search_from">
	<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
    <tr>
			<th>标题 : </th>
			<td><input name="s_title" type="text" class="col-xs-10 col-sm-3 col-lg-3 col-md-3"></td>
		</tr><tr>
			<th>证书 : </th>
			<td><input name="s_picture" type="text" class="easyui-textbox col-xs-6 col-sm-2 col-lg-2 col-md-2" style="height:30px;"></td>
		</tr><tr>
			<th>状态 : </th>
...
<table id="Qualification_Data_List"></table>

<script type="text/javascript">
$(function() {
	$("#Qualification_Data_List").datagrid({
		url : "<?php echo U('Qualification/index');?>",
		fit : true,
		striped : true,
		border : false,
		pagination : true,
		...
		sortName : 'id',
		sortOrder : 'desc',
		toolbar : '#Qualification_Bar',
		singleSelect : true,
		columns : [[
            {field : 'id',title : 'ID',width : 40,sortable:true},
{field : "title",title : "标题",width :100,sortable:true},{field : "picture",title : "证书",width :100,sortable:true},{field : "state",title : "状态",width :100,sortable:true,formatter: function (value, row, index) {
			...
			return op_state[value];
				...
				<?php if(Is_Auth('Admin/Qualification/edit')): ?>operate_menu = operate_menu+"<a href='<?php echo U('edit'); ?>&id="+row.id+"' >编辑</a>";<?php endif; ?>

				<?php if(Is_Auth('Admin/Qualification/del')): ?>operate_menu = operate_menu+" | <a href='#' onclick=\"Data_Remove('<?php echo U('del'); ?>&id="+row.id+"','Qualification_Data_List');\">删除</a>";<?php endif; ?>
