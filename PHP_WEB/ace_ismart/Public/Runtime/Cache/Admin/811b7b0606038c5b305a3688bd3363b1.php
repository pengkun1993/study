	...
	<script type="text/javascript">
		$("#content_editor").blur(function()
		{
			$("#editor_content").html($("#content_editor").html());
				...
				<hr/><div class="form-group">
					...
					<div class="col-xs-11">
						<select name="state" class="col-xs-7 col-sm-3 col-lg-3 col-md-3" id="s_state"  def-data="<?php echo ($_info['state']); ?>"><option value="1">显示</option><option value="0">隐藏</option></select><script type="text/javascript">
		...
		for(var i=0;i<opt.length;i++){
			if(def==opt[i].value){
				...
				<hr/><div class="form-group">
					<label class="col-sm-1 control-label no-padding-right" for="form-field-1">首页展示:</label>

					<div class="col-xs-11">
						<select name="show_index" class="col-xs-7 col-sm-3 col-lg-3 col-md-3" id="s_show_index"  def-data="<?php echo ($_info['show_index']); ?>"><option value="0">不展示</option><option value="1">展示</option></select><script type="text/javascript">
