            ...
            <div id="topNav" class="clearfix">
                <div style="float: left;"> 
                    <font id="ECS_MEMBERZONE">
                        ...
                        欢迎光临本店&nbsp;
                        <a href="/Study/PHP_WEB/XiangMu/Shop/index.php/Home/user/login.html"> 登录</a>
                        <a href="/Study/PHP_WEB/XiangMu/Shop/index.php/Home/user/register.html">注册</a>
                    </font>
                </div>
        ...
        <div class="block clearfix">
                ...
                <div class="box">
                    ...
                    <div class="box_1">
                        <div class="top10List clearfix">
                            <ul class="clearfix">
                                <img src="<?php echo (HOME_IMG); ?>top_1.gif" class="iteration">
                                    <li class="topimg">
                                        <a href="#"><img src="<?php echo (HOME_IMG); ?>3_thumb_G_1241422082679.jpg" alt="" class="samllimg"></a>
                                    </li>
                            ...
                            <ul class="clearfix">
                                <img src="<?php echo (HOME_IMG); ?>top_2.gif" class="iteration">
                                    <li class="topimg">
                                        <a href="#"><img src="<?php echo (HOME_IMG); ?>24_thumb_G_1241971981429.jpg" alt="" class="samllimg"></a>
                                    </li>
                            ...
                            <ul class="clearfix">
                                <img src="<?php echo (HOME_IMG); ?>top_3.gif" class="iteration">
                                    <li class="topimg">
                                        <a href="#"><img src="<?php echo (HOME_IMG); ?>12_thumb_G_1241965978410.jpg" alt="" class="samllimg"></a>
                                    </li>
                            ...
                            <ul class="clearfix">
                                <img src="<?php echo (HOME_IMG); ?>top_4.gif" class="iteration">
                            ...
                            <ul class="clearfix">
                                <img src="<?php echo (HOME_IMG); ?>top_5.gif" class="iteration">
                            ...
                            <ul class="clearfix">
                                <img src="<?php echo (HOME_IMG); ?>top_6.gif" class="iteration">
                            ...
                            <ul class="clearfix">
                                <img src="<?php echo (HOME_IMG); ?>top_7.gif" class="iteration">
                ...
                <div class="blank5"></div><div class="box">  <h3><span>品牌专区</span></h3>
                    <div class="box_1">
                        <div class=" brands clearfix">
                            <a href="#"><img src="<?php echo (HOME_IMG); ?>1240803062307572427.gif" alt="诺基亚 (7)"></a>
                            <a href="#"><img src="<?php echo (HOME_IMG); ?>1240802922410634065.gif" alt="摩托罗拉 (1)"></a>
                            <a href="#"><img src="<?php echo (HOME_IMG); ?>1240803144788047486.gif" alt="多普达 (1)"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="AreaM">
                <div class="box clearfix">
                    <div id="focus">
                        <img src="<?php echo (HOME_IMG); ?>111.jpg" width="515" height="160" alt="" />
                    </div>       
                </div>
                <div class="blank"></div>
                ...
                <div id="show_hot_area" class="clearfix">
                    ...
                    <div class="goodsItem">
                        ...
                        <a href="#"><img src="<?php echo (HOME_IMG); ?>1_thumb_G_1240902890710.jpg" alt="KD876" class="goodsimg"></a><br />
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo (HOME_IMG); ?>ecmoban_link.jpg" alt="YONGDA商城" border="0"></a>

                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="<?php echo (HOME_IMG); ?>yongda_logo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
