            ...
            <div id="topNav" class="clearfix">
                <div style="float: left;"> 
                    <font id="ECS_MEMBERZONE">
                        ...
                        <a href="/index.php/Home/user/register.html">注册</a>
                    </font>
                </div>
            ...
            <div class="block box">
                ...
                <div class="usBox">
                    <div class="usBox_2 clearfix">
                        ...
                        <form id="yw0" action="/index.php/Home/user/register.html" method="post">                
                        <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:87%;">
                                            <input class="inputBg" size="25" name="username" id="User_username" type="text" value="<?php echo ($old_data[username]); ?>" /> 
                                            <span style="color:red;"><?php echo ($error_data[username]); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="password" id="User_password" type="password" value="<?php echo ($old_data[password]); ?>" />
                                            <span style="color:red;"><?php echo ($error_data[password]); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <span style="color:red;"><?php echo ($error_data[password2]); ?></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="user_email" id="User_user_email" type="text" value="<?php echo ($old_data[user_email]); ?>" /> 
                                            <span style="color:red;"><?php echo ($error_data[user_email]); ?></span>   
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="user_qq" id="User_user_qq" type="text" value="<?php echo ($old_data[user_qq]); ?>" />
                                            <span style="color:red;"><?php echo ($error_data[user_qq]); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="User_user_tel">手机</label></td>
                                        <td>
                                            <input class="inputBg" size="25" name="user_tel" id="User_user_tel" type="text" value="<?php echo ($old_data[user_tel]); ?>" />
                                            <span style="color:red;"><?php echo ($error_data[user_tel]); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="errorMessage" id="User_user_xueli_em_" style="display:none">
                                            </div>
                                            <span style="color:red;"><?php echo ($error_data[user_xueli]); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span style="color:red;"><?php echo ($error_data[user_hobby]); ?></span>                               
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea cols="50" rows="5" name="user_introduce" id="User_user_introduce"><?php echo ($old_data[user_introduce]); ?></textarea>                      
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
