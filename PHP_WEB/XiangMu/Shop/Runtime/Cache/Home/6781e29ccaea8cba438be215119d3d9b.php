...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo (HOME_CSS); ?>style.css" rel="stylesheet" type="text/css" />
        
    </head>
    <body style="cursor: auto;">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="#" name="top">
                <HOME_IMG class="logo" src="<?php echo (HOME_IMG); ?>logo.gif" />
            </a>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" >
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('<?php echo (HOME_IMG); ?>sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;" type="submit" />
            </form>
        </div>
        <div class="blank5"></div>
        <div class="header_bg_b">
            <div class="f_l" style="padding-left: 10px;">
                <HOME_IMG src="<?php echo (HOME_IMG); ?>biao6.gif">
                    北京市区，现在下单(截至次日00:30已出库)，<b>明天上午(9-14点)</b>送达 <b>免运费火热进行中！</b>
            </div>
            <div class="f_r" style="padding-right: 10px;">
                <HOME_IMG style="vertical-align: middle;" src="<?php echo (HOME_IMG); ?>biao3.gif">
                    <span class="cart" id="ECS_CARTINFO">
                        <a href="#" title="查看购物车">您的购物车中有 1 件商品，总计金额 ￥2000.00元。</a></span>
                    <a href="#"><HOME_IMG style="vertical-align: middle;" src="<?php echo (HOME_IMG); ?>biao7.gif"></a>
        ...
        <div class="block clearfix">
                ...
                <div style="display: block;" class="box" id="history_div">
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix"><li class="goodsHOME_IMG"><a href="#" target="_blank"><HOME_IMG src="<?php echo (HOME_IMG); ?>8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue"></a></li><li><a href="#" target="_blank" title="飞利浦9@9v">飞利浦9@9v</a><br />本店售价：<font class="f1">￥399元</font><br /></li></ul><ul class="clearfix"><li class="goodsHOME_IMG"><a href="#" target="_blank"><HOME_IMG src="<?php echo (HOME_IMG); ?>9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue"></a></li><li><a href="#" target="_blank" title="诺基亚E66">诺基亚E66</a><br />本店售价：<font class="f1">￥2298元</font><br /></li></ul><ul class="clearfix"><li class="goodsHOME_IMG"><a href="#" target="_blank"><HOME_IMG src="<?php echo (HOME_IMG); ?>17_thumb_G_1241969394587.jpg" alt="夏新N7" class="B_blue"></a></li><li><a href="#" target="_blank" title="夏新N7">夏新N7</a><br />本店售价：<font class="f1">￥2300元</font><br /></li></ul><ul id="clear_history"><a onclick="clear_history()">[清空]</a></ul>  </div>
                    </div>
                </div>
                <div class="blank5"></div>
            </div>
            ...
            <div class="AreaR">
                <div id="goodsInfo" class="clearfix">
                    <div class="HOME_IMGInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="<?php echo (HOME_IMG); ?>200905/goods_HOME_IMG/9_P_1241511871575.jpg" id="zoom1" class="MagicZoom MagicThumb" title="诺基亚E66">
                            <HOME_IMG id="sim806035" src="<?php echo (HOME_IMG); ?>9_G_1241511871574.jpg" alt="诺基亚E66" height="310px" width="310px;" />
                            <div class="MagicZoomBigImageCont" style="width: 200px; height: 269px; overflow: hidden; z-index: 100; visibility: visible; position: absolute; top: -10000px; left: 327px; display: block;" id="bc806035">
                                ...
                                <div style="overflow: hidden;">
                                    <HOME_IMG style="position: relative; border-width: 0px; padding: 0px; left: 0px; top: 0px; display: block; visibility: visible;" src="<?php echo (HOME_IMG); ?>9_P_1241511871575.jpg" />
                                </div>
                        ...
                        <div style="text-align: center; position: relative; width: 100%;">
                            <a href="#">
                                <HOME_IMG style="position: absolute; left: 0pt;" alt="prev" src="<?php echo (HOME_IMG); ?>up.gif" /></a>
                            <a href="javascript:;" onclick="window.open('gallery.php?id=9'); return false;">
                                <HOME_IMG alt="zoom" src="<?php echo (HOME_IMG); ?>zoom.gif" />
                            </a>
                            <a href="#">
                                <HOME_IMG style="position: absolute; right: 0pt;" alt="next" src="<?php echo (HOME_IMG); ?>down.gif" /></a>
                        </div>
                        <div class="blank5"></div>

                        <div class="picture" id="HOME_IMGlist">
                            <a style="outline: 0pt none;" href="<?php echo (HOME_IMG); ?>200905/goods_HOME_IMG/9_P_1241511871575.jpg" rel="zoom1" rev="images/200905/goods_HOME_IMG/9_P_1241511871575.jpg" title="">
                                <HOME_IMG src="<?php echo (HOME_IMG); ?>9_thumb_P_1241511871787.jpg" alt="诺基亚E66" class="onbg" /></a>
                        </div>
                    </div>
                        ...
                        <form action="javascript:addToCart(9)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>用户评价：</strong>
                                        <HOME_IMG src="<?php echo (HOME_IMG); ?>stars5.gif" alt="comment rank 5">
                                    </dd>
                                </li>
                                <li class="padd">
                                ...
                                <li class="padd">
                                    <a href="#"><HOME_IMG src="<?php echo (HOME_IMG); ?>goumai2.gif"></a>
                                    <a href="#"><HOME_IMG src="<?php echo (HOME_IMG); ?>shoucang2.gif"></a>
                                    <a href="#"><HOME_IMG src="<?php echo (HOME_IMG); ?>tuijian.gif"></a>
                                </li>
                            </ul>
                        </form>
                    </div>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <div class="goodsItem">
                                <a href="#">
                                    <HOME_IMG src="<?php echo (HOME_IMG); ?>24_thumb_G_1241971981429.jpg" alt="P806" class="goodsHOME_IMG"></a><br />
                                <p><a href="#" title="P806">P806</a></p> 
                                <font class="shop_s">￥2000元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <HOME_IMG src="<?php echo (HOME_IMG); ?>22_thumb_G_1241971076803.jpg" alt="多普达Touch HD" class="goodsHOME_IMG" /></a><br />
                                <p><a href="#" title="多普达Touch HD">多普达Touc...</a></p> 
                                <font class="shop_s">￥5999元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <HOME_IMG src="<?php echo (HOME_IMG); ?>13_thumb_G_1241968002527.jpg" alt="诺基亚5320 XpressMusic" class="goodsHOME_IMG" /></a><br />
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div style="padding-left: 15px; text-align: left; float: left;">
                                                            ...
                                                            <HOME_IMG src="<?php echo (HOME_IMG); ?>captcha.png" alt="captcha" onclick="this.src='captcha.php?'+Math.random()" class="captcha" />
                                                        </div>
        ...
        <div class="blank"></div>
        <div class="block">
            <a href="#" target="_blank" title="YONGDA商城"><HOME_IMG alt="YONGDA商城" src="<?php echo (HOME_IMG); ?>di.jpg" /></a>
            <div class="blank"></div>
        </div>
        <div class="block">
            <div class="box">
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><HOME_IMG src="<?php echo (HOME_IMG); ?>goods.htm" alt="YONGDA商城" border="0" /></a>
        ...
        <HOME_IMG class="MagicThumb-image" style="position: absolute; top: -9999px; display: none;" src="<?php echo (HOME_IMG); ?>9_P_1241511871575.jpg" />
        <HOME_IMG src="<?php echo (HOME_IMG); ?>controlbar.htm" style="position: absolute; top: -999px;" />
        <HOME_IMG style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo (HOME_IMG); ?>9_P_1241511871575.jpg" />
        <HOME_IMG style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo (HOME_IMG); ?>9_P_1241511871575.jpg" />
    </body>
</html>