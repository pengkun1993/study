...
Page({
	...
	onLoad:function(options){
		...
		console.log('pageB >> onLoad , options ::',options);
	},
	onReady:function(){
	...
	navigateToC:function(){
		...
		console.log('%cpageB============navigateToC=========','color:red');
		wx.navigateTo({
	...
	redirectToC:function(){
		...
		console.log('%cpageB============redirectToC=========','color:red');
		wx.redirectTo({
			url:'/pages/page-c/index'
		});
	},
	reLaunchToC:function(){
		//关闭所有页面，打开到应用内的某个页面
		console.log('%cpageB============reLaunchToC=========','color:red');
		wx.reLaunch({
			url:'/pages/page-c/index'
		})
	}
