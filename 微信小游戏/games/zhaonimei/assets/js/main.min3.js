...
shareData = {
    imgUrl: "http://bbs.52jscn.com/games/zhaonimei/zhaonimei.jpg",
    timeLineLink: "http://bbs.52jscn.com/games/zhaonimei/",
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://bbs.52jscn.com/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://bbs.52jscn.com/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
