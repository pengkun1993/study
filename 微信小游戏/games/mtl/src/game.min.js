		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://bbs.52jscn.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://bbs.52jscn.com";
y.url = function() {
	return "http://bbs.52jscn.com?u="+ Math.floor(Math.random()*10000000);
};
