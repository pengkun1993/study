...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://bbs.52jscn.com/games/duimutou/icon.png",
		url: "http://bbs.52jscn.com/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注锦尚中国:viying01"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://bbs.52jscn.com/games/duimutou/i/icon.png';
	lineLink = 'http://bbs.52jscn.com/games/duimutou';
