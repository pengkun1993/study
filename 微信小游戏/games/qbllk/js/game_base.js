if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://bbs.52jscn.com/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://bbs.52jscn.com/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://bbs.52jscn.com/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://bbs.52jscn.com/");
...
window.shareData = {
    "imgUrl": "http://bbs.52jscn.com/icon/qbllk.png",
    "timeLineLink": "http://bbs.52jscn.com/games/qbllk/",
    "tTitle": "奇葩连连看-锦尚中国",
